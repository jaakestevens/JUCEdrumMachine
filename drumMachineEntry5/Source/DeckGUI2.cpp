...
void DeckGUI2::resized()
{
    ...
    speedSlider.setBounds(getWidth() * .2, row * 5.5, getWidth() * .7, row * 1.8);
    
    speedReset.setBounds(getWidth() * .8, row * 6, getWidth() * .2, row);
    waveformDisplay.setBounds(getWidth() * .1,row * 7.5, getWidth() * .8, row * 2);
    ...
    speedLabel.setBounds(getWidth() * .3, row * 5.2, getWidth() * .4, row);
